...
class MainActivity : ComponentActivity() {
  ...
  // createSampleFlagService() is generated by flagfit-ksp and does not use reflection.
  // You can also use `flagfit.create<SampleFlagService>()` which is based on dynamic proxy.
  private val sampleFlagService: SampleFlagService = flagfit.createSampleFlagService()
